...
import dsa.testcase.leetcode.RotateImageTestCaseSet;
...
public class RotateImageSolution implements Solution<int[][], Void> {
    ...
    public Void solve(int[][] matrix) {
        ...
        return null; // Modifies the matrix in-place
    }

    @Override
    public TestCaseSet<int[][], Void> getTestCaseSet() {
        return RotateImageTestCaseSet.getInstance();
    }
}